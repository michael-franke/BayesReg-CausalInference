...
\vspace{-0.5cm}
\marginnote{Compare these results to the MLE approach in Info Box 2 \mf{check reference}: Both methods yield very similar predictions. This might have been different had we set strong priors in our Bayesian regression.}
